    ...
    function searchInJson(year){
        ...
        if ((year >= 1903 && year < 1915) || (year > 1918 && year < 1940) || (year > 1946 && year <= 2017))  {
            if (data[year].Winner.name == 'd\u00e9sattribu\u00e9')
                ...
                $('#winner').html('Gagnant du Tour de France : ' + data[year].Winner.name + ' (' + data[year].Winner.nationality + ')');
            if (data[year].Winner.name != 'none' && data[year].Climber.nationality != "none")
                $('#climber').html('Meilleur grimpeur : ' + data[year].Climber.name + ' (' + data[year].Climber.nationality + ')');
            if (year < 1953)
                ...
                $('#sprinter').html('Meilleur sprinteur : ' + data[year].Sprinter.name + ' (' + data[year].Sprinter.nationality + ')');
        }
